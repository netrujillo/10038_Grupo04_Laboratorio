...
<body>
    ...
    <div class="container-fluid bg-light position-relative shadow">
        ...
        <?php
            ...
            $query_name = mysqli_query($conection, "SELECT nombrepais, capital, moneda, plato, foto FROM pais WHERE idpais=2");
    ...
    <div class="container-fluid bg-primary px-0 px-md-5 mb-5">
        <div class="row align-items-center px-3">
            <div class="col-lg-6 text-center text-lg-left">
                ...
                <p class="text-white mb-4">Sudáfrica es un país del extremo más meridional del continente africano que se caracteriza por sus numerosos ecosistemas distintos. En el interior, el Parque Nacional Kruger es un destino para el safari, poblado de caza mayor.</p>
            </div>
    ...
    <table class="table table-striped table-hover" style="width: 30rem; margin: 0 auto; text-align: center; margin-bottom: 10rem;">
        ...
        <tbody>
            ...
            $query_provincias = mysqli_query($conection, "SELECT idprovincia, nombre_provincia FROM provincia WHERE pais_id=2 AND estatus = 1 ORDER BY idprovincia ASC LIMIT $desde,$por_pagina");
    ...
    <table class="table table-striped table-hover" style="width: 30rem; margin: 0 auto; text-align: center; margin-bottom: 5rem;">
        ...
        <tbody>
            ...
            $query_ciudades = mysqli_query($conection, "SELECT u.idciudad, u.nombre_ciudad, u.postal, r.nombre_provincia, r.pais_id FROM ciudad u INNER JOIN provincia r ON u.provincia_id = r.idprovincia AND r.pais_id=2 WHERE u.estatus = 1 ORDER BY idciudad ASC LIMIT $desde,$por_pagina");;

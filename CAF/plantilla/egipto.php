...
<body>
    ...
    <div class="container-fluid bg-light position-relative shadow">
        ...
        <?php
            ...
            $query_name = mysqli_query($conection, "SELECT nombrepais, capital, moneda, plato, foto FROM pais WHERE idpais=1");
    ...
    <table class="table table-striped table-hover" style="width: 30rem; margin: 0 auto; text-align: center; margin-bottom: 10rem;">
        ...
        <tbody>
            ...
            $query_provincias = mysqli_query($conection, "SELECT idprovincia, nombre_provincia FROM provincia WHERE pais_id=1 AND estatus = 1 ORDER BY idprovincia ASC LIMIT $desde,$por_pagina");
    ...
    <table class="table table-striped table-hover" style="width: 30rem; margin: 0 auto; text-align: center; margin-bottom: 5rem;">
        ...
        <tbody>
            ...
            $query_ciudades = mysqli_query($conection, "SELECT u.idciudad, u.nombre_ciudad, u.postal, r.nombre_provincia, r.pais_id FROM ciudad u INNER JOIN provincia r ON u.provincia_id = r.idprovincia AND r.pais_id=1 WHERE u.estatus = 1 ORDER BY idciudad ASC LIMIT $desde,$por_pagina");;

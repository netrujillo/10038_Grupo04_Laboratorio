...
<body>
	...
	<table class="table table-striped table-hover">
	    ...
	    <?php
			...
			$query = mysqli_query($conection, "SELECT u.idusuario, u.nombre, u.telefono, u.usuario, r.rol FROM usuario u INNER JOIN rol r ON u.rol = r.idrol WHERE estatus = 1 ORDER BY idusuario ASC LIMIT $desde,$por_pagina");

...
<body>
	...
	<table class="table table-striped table-hover">
	    ...
	    <?php
			...
			$query = mysqli_query($conection, "SELECT u.idciudad, u.nombre_ciudad, u.postal, r.nombre_provincia FROM ciudad u INNER JOIN provincia r ON u.provincia_id = r.idprovincia WHERE u.estatus = 1 ORDER BY idciudad ASC LIMIT $desde,$por_pagina");
